...
final List<Movie> mockMovies = [
  Movie(
    ...
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/16/bo-gia-tro-lai-500_1768535842789.jpg'],
    durationMin: 95,
    ageRating: 'C18',
  ...
  Movie(
    id: 2,
    title: 'Tiểu Yêu Quái Núi Lãng Lãng',
    categories: [defaultCategories[1]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/13/nobody-500_1768273580665.jpg'],
    durationMin: 118,
    ageRating: 'P',
  ...
  Movie(
    id: 3,
    title: 'Đồi Câm Lặng: Ác Mộng Trong Sương',
    categories: [defaultCategories[2], defaultCategories[3]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/16/silent-hill-2-500_1768557335828.jpg'],
    durationMin: 106,
    ageRating: 'T18',
  ...
  Movie(
    ...
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/20/bang-chung-sinh-tu-500_1768879551747.jpg'],
    durationMin: 100,
    ageRating: 'C18',
    description: '',
    trailerPaths: [],
  ...
  Movie(
    ...
    categories: [defaultCategories[1]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/15/conan-500_1768461797973.jpg'],
    durationMin: 95,
    ageRating: 'P',
  ...
  Movie(
    ...
    categories: [defaultCategories[2], defaultCategories[3]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/12/28-year-500_1768210133214.jpg'],
    durationMin: 107,
    ageRating: 'C18',
  ...
  Movie(
    id: 7,
    title: 'Tom And Jerry: Chiếc La Bàn Kỳ Bí',
    categories: [defaultCategories[1]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2025/12/26/tom-and-jerry-500_1766725769417.jpg'],
    durationMin: 98,
    ageRating: 'P',
  ...
  Movie(
    ...
    categories: [defaultCategories[1]],
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2025/11/3/zootopia-500_1762159348935.jpg'],
    durationMin: 107,
    ageRating: 'P',
  ...
  Movie(
    ...
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2025/12/15/avatar-3-500_1765782293833.jpg'],
    durationMin: 197,
    ageRating: 'C18',
  ...
  Movie(
    ...
    actors: 'Sparkle, Sparxie',
    posterPaths: ['https://cdn.galaxycine.vn/media/2026/1/12/jaw-500_1768208979911.jpg'],
    durationMin: 124,
    ageRating: 'C18',
